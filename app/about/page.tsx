    ...
    <div className="bg-white/80 p-6 rounded-lg shadow-lg w-full max-w-lg overflow-y-auto h-[90vh] scrollbar-hide">
     ...
     {/* Groom's Content */}
      <div className="text-center space-y-4">
          ...
          <p className="sm:text-xl md:text-xl lg:text-1xl xl:text-2xl font-bold text-[#ff69b4]">မောင်အောင်နိုင်ဖြိုး</p>
          {/* text-2xl */}
     ...
     {/* Bride's Content */}
        <p className="text-base sm:text-lg md:text-xl lg:text-xl xl:text-xl text-gray-800">
          ...
          <p className="sm:text-xl md:text-xl lg:text-1xl xl:text-2xl font-bold text-[#ff69b4]">မအေးအေးစိုး</p>
